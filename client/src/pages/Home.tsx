        ...
        <>
          ...
          {!isCaseStudyOpen && !isEntered && (
            <>
              ...
              >
                <span className={`${isEntered || whiteSectionProgress > 0.5 ? 'text-black/40' : 'text-white/40'} text-sm font-bold tracking-[0.3em] uppercase`}>Scroll</span>
                <motion.div
                  className={`w-[1px] h-6 ${isEntered || whiteSectionProgress > 0.5 ? 'bg-black/20' : 'bg-white/20'}`}
