...
export default function Home() {
  ...
  const [logoSequenceProgress, setLogoSequenceProgress] = useState(0);
  ...
  const handleLogoSequenceProgress = useCallback((progress: number) => {
    setLogoSequenceProgress(progress);
  }, []);
      ...
      {!isLoading && (
        <>
          ...
          <Scene3D
            ...
            onLogoSequenceProgress={handleLogoSequenceProgress}
          />
          ...
          <WhiteSection progress={whiteSectionProgress} circleProgress={circleProgress} logoSequenceProgress={logoSequenceProgress} />
