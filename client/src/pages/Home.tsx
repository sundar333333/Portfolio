...
export default function Home() {
  ...
  const [currentTransitionProgress, setCurrentTransitionProgress] = useState(0);
  ...
  const handleCurrentTransitionProgress = useCallback((progress: number) => {
      ...
      {!isLoading && (
        <>
          ...
          <Scene3D
            ...
            onCurrentTransitionProgress={handleCurrentTransitionProgress}
          />
          ...
          <WhiteSection progress={whiteSectionProgress} circleProgress={circleProgress} currentTransitionProgress={currentTransitionProgress} />
