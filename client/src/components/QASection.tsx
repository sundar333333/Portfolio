...
const qaData = [
  {
    question: "Who Am I ?",
    answer: "I'm Sundar Ram, a multidisciplinary designer with a strong foundation in both design and technology. I create digital experiences that are visually engaging, intuitive, and user-centered, with a strong focus on clarity and usability.\n\nWith a background in computer applications, I approach design through a problem-solving mindset. I enjoy understanding how products work behind the scenes, which helps me design solutions that are not only beautiful but also practical and effective.\n\nI believe great design should feel effortless to users while solving meaningful problems in subtle ways. I'm constantly learning, experimenting, and refining my skills to build experiences that truly add value."
  },
  {
